    ...
    return (
        ...
        text-gray-900'> Skills </h3>
                <p className='text-sm text-gray-500'>
                    Add your technical and soft skills </p>
            </div>
        ...
        (e.g., JavaScript, Project Management)"
                ...
                <button onClick={addSkill} disabled={!newSkill.trim}
                    className='flex items-center gap-2 px-4 py-2 text-sm bg-blue-600 
        ...
        disabled:opacity-50 disabled:cursor-not-allowed'>
            ...
            <div className='bg-blue-50 p-3 rounded-lg'>
                <p className='text-sm text-blue-800'><strong>Tip:</strong> 
