...
const Footer = () => {
  return (
     <>
            ...
            <footer className="flex flex-wrap justify-center lg:justify-between overflow-hidden gap-10 md:gap-20 py-16 px-6 md:px-16 lg:px-24 xl:px-32 text-[13px] bg-gradient-to-r from-white via-green-300/60 to-white mt-40">
                <div className="flex flex-wrap items-start gap-10 md:gap-[60px] xl:gap-[140px]">
                    <a href="#">
                       <img src="/logo.svg" alt="logo" className='h-11 w-auto' />
                    </a>
                    <div>
                        <p className="text-black-500 font-semibold">Product</p>
                    ...
                    <div>
                        <p className="text-black-100 font-semibold">Resources</p>
                        <ul className="mt-2 space-y-2">
                            ...
                            <li><a href="/" className="hover:text-indigo-600 transition">Careers<span className="text-xs text-white bg-green-600 rounded-md ml-2 px-2 py-1">We’re hiring!</span></a></li>
                            <li><a href="/" className="hover:text-indigo-600 transition">About</a></li>
                        </ul>
                    </div>
                    <div>
                        <p className="text-black-100 font-semibold">Legal</p>
                        <ul className="mt-2 space-y-2">
                ...
                <div className="flex flex-col max-md:items-center max-md:text-center gap-2 items-end">
                    ...
                    <p className="mt-3 text-center">© 2026 <a href="/">Huzaifa Moin</a></p>
                </div>
            </footer>
        </>
  )
