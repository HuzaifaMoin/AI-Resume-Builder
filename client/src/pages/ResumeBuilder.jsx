...
import { ArrowLeftIcon, User, FileText, Briefcase, GraduationCap, 
  FolderIcon, Sparkles, ChevronRight, ChevronLeft, Share2Icon, EyeIcon, 
  EyeOffIcon, DownloadIcon } from 'lucide-react';
        ...
        <div className='grid lg:grid-cols-12 gap-8'>
          ...
          <div className='relative lg:col-span-5 rounded-lg overflow-hidden'>
            <div className='bg-white rounded-lg shadow-sm border border-gray-200 p-6 pt-1'>
              ...
              {/* Section Nav */}
              <div className='flex-justify-between items-center mb-6 border-1 border-gray-200 py-1'>
            ...
            text-gray-600 hover:bg-gray-50 transition-all ${activeSectionIndex === sections.length - 1 && 'opacity-50'}`}
              ...
              <button onClick={()=>{toast.promise(saveResume, {loading: 'Saving...'})}} className='bg-gradient-to-br from-green-100 
             to-green-200 ring-green-300 text-green-600 ring 
             hover:ring-green-400 transition-all rounded-md px-6
             py-2 mt-6 text-sm'>
                Save Changes
              </button>
            </div>
              ...
              <div className='relative w-full'>
                ...
                items-center justify-end gap-2'>
                  {resumeData.public && (
                    ...
                    className='flex items-center p-2 px-4 gap-2 
                    text-xs bg-gradient-to-br from-blue-100 to-blue-200 
                  ...
                  text-purple-600 ring-purple-300 rounded-lg hover:ring 
                  transition-colors'>
                  ...
                  text-xs bg-gradient-to-br from-green-100 to-green-200 
